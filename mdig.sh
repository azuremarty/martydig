...
#======================================== 
#NS1IMH=$( dig @ns1.inmotionhosting.com $1 +short | grep [0-9][0-9] | head -n 1 )
#NS2IMH=$( dig @ns2.inmotionhosting.com $1 +short | grep [0-9][0-9] | head -n 1 )
#======================================== 
#NS1HUB=$( dig @ns1.webhostinghub.com $1 +short | grep [0-9][0-9] | head -n 1 )
#NS2HUB=$( dig @ns2.webhostinghub.com $1 +short | grep [0-9][0-9] | head -n 1 )
#======================================== 
#NS1IMHPTR=$( dig -x $NS1IMH +short | grep -v "in-addr" | head -n 1 )
#NS2IMHPTR=$( dig -x $NS2IMH +short | grep -v "in-addr" | head -n 1 )
#======================================== 
#NS1HUBPTR=$( dig -x $NS1HUB +short | grep -v "in-addr" | head -n 1 )
#NS2HUBPTR=$( dig -x $NS2HUB +short | grep -v "in-addr" | head -n 1 )
#=================================================================
clear
echo -e "${BLUE}|${BOLD} __  __    __    ____  ____  _  _  ____  ____  ___  _ ${BLUE}|${NC}"
echo -e "${BLUE}|${BOLD}(  \/  )  /__\  (  _ \(_  _)( \/ )(  _ \(_  _)/ __)| |${BLUE}|${NC}"
echo -e "${BLUE}|${BOLD} )    (  /(__)\  )   /  )(   \  /  )(_) )_)(_( (_-.|_|${BLUE}|${NC}"
echo -e "${BLUE}|${BOLD}(_/\/\_)(__)(__)(_)\_) (__)  (__) (____/(____)\___/(_)${BLUE}|${NC}"
